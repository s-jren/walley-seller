  ...
  return (
    <div>
      <Form
        submit={(form) => {
          alert(
            `Domain name is ${form.domain} and contract address is ${form.contractAddress}`
          );
        }}
        initialValues={{
          domain: "",
      ...
      >
        <div>
          <FormInput
            className="domain"
            name="domain"
            placeholder="Connect with custom domain"
          />
        </div>
        <div>
          <FormInput
            ...
            placeholder="Enter in NFT collection address"
          />
        </div>
      </Form>
    </div>
